...
tempDataShown='<img class="full b-lazy" alt="itemPic"  src="'+placeholder+'" data-src="'+newsData[i].imgSrc+'-320.jpg" "';
tempDataHidden='<img class="full" alt="itemPic"  src="'+newsData[i].imgSrc+'-320.jpg" "';
    ...
    hiddenData+='<div id="article'+newsData[i].id+'" class="item lityItem">'+tempDataHidden+tempData+'</div>';
    shownData+='<a href="#article'+newsData[i].id+'" class="newsAnchor" data-lightbox><div class="item">'+tempDataShown+tempData+'</div></a>';
  }
...
var truncObjs=[];
var truncateAllTheThings =function(){
