(function($, window) {
//  var bLazy = new Blazy();
var placeholder2 = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNkEC+vBwABvAEP2J2F2AAAAABJRU5ErkJggg==";
  var topSliderData = [{
      "id": 1,
  ...
  $(document).ready(function() {
    ...
    function initTopSlider() {
      ...
      for (var i = 0; i < topSliderData.length; i++) {
        ...
        topSliderHtml += "<img data-sizes='auto' style='opacity:" + topSliderData[i].imgOpacity + "' class='topSliderImg lazyload' data-src='" + placeholder2 + "'" +
          " data-srcset='" + topSliderData[i].imgSrc + "-640" + topSliderData[i].ext + " 640w, " +
        ...
        topSliderHtml += "<img data-sizes='auto' class='topSliderLogo lazyload' data-src='" + placeholder2 + "'" +
          ...
          "dist/assets/svg/HeadRecreationWhiteOutline-675.png 1200w' alt='topLogo'>";
        }
        topSliderHtml +=  "</div>";
      }
    ...
    var initAwards = function() {
      ...
      var gallery2016 = ["_MG_6702", "_MG_7071", "_MG_6568", "_MG_6710", "_MG_6550", "_MG_6558", "_MG_6566", "_MG_6639", "_MG_6660", "_MG_6530", "_MG_6531", "_MG_6536", "_MG_6577", "_MG_6579", "_MG_6605", "_MG_6624", "_MG_6636", "_MG_6643", "_MG_6689", "_MG_6695", "_MG_6723", "_MG_6724", "_MG_6733", "_MG_6740", "_MG_6745", "_MG_6748", "_MG_6759",
        "_MG_6760", "_MG_6762", "_MG_6806", "_MG_6810", "_MG_6827", "_MG_6842", "_MG_6868", "_MG_6956", "_MG_6924", "_MG_6929", "_MG_6951", "_MG_6958", "_MG_6963", "_MG_6973", "_MG_6988", "_MG_7006", "_MG_7007", "_MG_7022", "_MG_7035", "_MG_7084", "_MG_7093", "_MG_7112",
      ...
      var gallery2017 = ["PIM_0117", "PIM_0129", "PIM_0012", "PIM_0019", "PIM_0024", "PIM_0027", "PIM_0031", "PIM_0034", "PIM_0040", "PIM_0046", "PIM_0048", "PIM_0053", "PIM_0056", "PIM_0058", "PIM_0067", "PIM_0072", "PIM_0075", "PIM_0085", "PIM_0089",
        "PIM_0095", "PIM_0102", "PIM_0106", , "PIM_0135", "PIM_0141", "PIM_0145", "PIM_0152", "PIM_0159", "33666664162_3ec4fefab3_o", "33666670362_c3d33d6890_o", "33666686942_19a686cd43_o", "PIM_0177",
      ...
      var buildGallery = function(year, a) {
        ...
        for (var i = 0; i < a.length; i++) {
          ...
          g += '<a href="dist/assets/images/nine/' + year + '/' + a[i] + '-320.jpg"' +
            ...
            '<img data-size="auto" class="myThumb lazyload" src="'+placeholder2+'" data-src="dist/assets/images/nine/' + year + '/' + a[i] + '-100.jpg" /></a>';
        }
    ...
    var initNews = function() {
      ...
      if (newsData && newsData.length > 0) {
        for (var i = 0; i < newsData.length; i++) {
          tempData = '<img data-size="auto" class="full lazyload" alt="itemPic"  data-src="' + placeholder2 + '"';
          tempData += 'data-srcset="' + newsData[i].imgSrc + '-320.jpg 640w, ' + newsData[i].imgSrc + '-900.jpg 900w, ' + newsData[i].imgSrc + '-1200.jpg 1200w">';
    ...
    */
    var initDesktopNews = function(){
      var hiddenData = '';
      var shownData = '';
      var tempData, tempDataShown, tempDataHidden;
      var horzScrollItemsWidth=0;
      if (newsData && newsData.length > 0) {
        for (var i = 0; i < newsData.length; i++) {
          horzScrollItemsWidth+=363;
          tempData = '<img class="lazyload" alt="itemPic"  data-src="' + newsData[i].imgSrc + '-320.jpg" src="'+placeholder2+'">';
          tempData += '<div class="detailContainer2"><div class="type2">' + (newsData[i].isMLArticle ? 'Miner&#39;s Lamp Article' : 'News Article') + '</div>';
          tempData += '<div><img src="' + (newsData[i].isMLArticle ? 'dist/assets/svg/Flame.svg' : 'dist/assets/svg/Newspaper.svg') + '" alt=""></div>';
          tempData += '<div class="date2">' + newsData[i].date + '</div></div>';
          tempData += '<div class="title2">' + newsData[i].title + '</div>';
          tempData += '<div class="content2">' + newsData[i].content + '</div>';
          shownData += '<a href="#article' + newsData[i].id + '" class="newsAnchor" data-lightbox><div class="myItem">' + tempData + '</div></a>';
        }
      }
      $(".horzScrollItems").css("width",horzScrollItemsWidth+"px");
      $(".horzScrollItems").append(shownData);


      /*  <table style="width: 750px;"><tr><td>okay</td></tr></table>
      <a href="#article2" class="newsAnchor" data-lightbox="">
      <div class="item"><img data-size="auto" class="full lazyloaded" alt="itemPic" data-src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNkEC+vBwABvAEP2J2F2AAAAABJRU5ErkJggg=="
      data-srcset="dist/assets/images/six/aImage2-320.jpg 640w, dist/assets/images/six/aImage2-900.jpg 900w, dist/assets/images/six/aImage2-1200.jpg 1200w" srcset="dist/assets/images/six/aImage2-320.jpg 640w, dist/assets/images/six/aImage2-900.jpg 900w, dist/assets/images/six/aImage2-1200.jpg 1200w" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNkEC+vBwABvAEP2J2F2AAAAABJRU5ErkJggg==">
      <div class="detailContainer">
      <div class="type">Miner's Lamp Article</div>
      <div class=""><img src="dist/assets/svg/Flame.svg" alt=""></div>
      <div class="date">March 29, 2017</div>
      </div>
      <div class="title">Candour, courage, new hope: the 2017 Miner’s Lamp Award dinner</div>
      <div class="content" data-ellipsis="3">
      </div>
      </div>
      </a>
      */
      ...
      $(".jspContainer").css("height","334px !important");
    };
    initTopSlider();
    initNews();
    initDesktopNews();
