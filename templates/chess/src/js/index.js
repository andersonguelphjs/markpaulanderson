...
function drawHTMLBoard() {
  ...
  $(document).ready(function() {
    ...
    for (var key in board2) {
      for (var k = 0; k < board2[key].length; k++) {
        console.log()
        $("[data-square='" + board2[key][k] + "']").find("img").attr("src", "src/img/" + key + ".png").attr("data-piece", key);
      }
